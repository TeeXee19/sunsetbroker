<template>
  <section class="grid md:grid-cols-3 justify-items-center items-center py-8 px-2 md:px-2 space-y-4 pb-[80px] mx-[5%] gap-4">
    <div class="rounded-tl-[64px] rounded-br-[64px] border border-2 border-primary-theme space-y-2 text-center justify-center md:py-[30px] px-3 w-[60%] md:w-[90%] flex flex-col bg-white shadow-lg h-[200px]">
    ...
    <div class="rounded-tl-[64px] rounded-br-[64px] border border-2 border-primary-theme space-y-2 text-center justify-center w-[60%] md:w-[90%] flex flex-col bg-primary-theme shadow-lg h-[200px]">
    ...
    <div class="rounded-tl-[64px] rounded-br-[64px] border border-2 border-primary-theme space-y-2 text-center justify-center py-6 px-3 w-[60%] md:w-[90%] flex flex-col bg-white shadow-lg h-[200px]">
