...
<nav id="navigation" class="bg-white py-8 sm:px-0 md:px-0 md:py-8 sticky top-0 z-40 font-body shadow-card hover:shadow-cardhover transition-all duration-500  border-b border-200">
    <div class="flex gap-8 items-center justify-between flex-wrap py-4 pt-0 pb-0 max-w-7xl mx-auto">
        ...
        <NuxtLink to="/" class="flex items-center flex-no-shrink ">
            <img src="public/assets/images/Logo.svg" class="h-[25px]" alt="logo" title="Go Home" />
        </NuxtLink>

        <div class="block md:hidden">
            <button type="button" class="inline-flex items-center justify-center border p-1 rounded text-grayTheme-400 border-400 hover:border-white focus:border-white hover:text-black focus:text-black focus:outline-none" aria-controls="mobile-menu" aria-expanded="false" @click="toggleVisibility">
